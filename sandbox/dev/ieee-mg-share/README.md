...
本技能是 **ieee-mg-writing**、**ieee-mg-polishing** 和 **ieee-mg-reviewer** 的公共组件层。三个技能共用的语料蒸馏成果（全局风格画像、术语规范、句式库、逻辑连接词、章节结构定义、定量基线）集中存放于此，避免重复维护。
...
| `static/quantitative-baseline.md` | 定量分析基线参考（writing/polishing/reviewer 共同使用，定量口径唯一权威） |
